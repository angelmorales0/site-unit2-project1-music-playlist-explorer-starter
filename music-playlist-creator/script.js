...
function makePlaylist(props){
    ...
    return `<article
          ...
          class="card">
<img onClick='openModal({owner:"${props.playlist_author}", title:"${props.playlist_name}", songs:${JSON.stringify(props.songs)}, playlist_art:"${props.playlist_art}"})' class="card-img" src="${props.playlist_art}" />          <div class="card-content" width="150px">
